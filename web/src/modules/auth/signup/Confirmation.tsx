    ...
    return (
        <div className="app-layout-blank flex flex-auto flex-col h-[100vh]">
            <div className="flex min-w-0 w-full flex-1">
                                ...
                                <div className="container mx-auto flex flex-col flex-auto items-center justify-center min-w-0 h-full">
                                    <div className="min-w-[320px] md:min-w-[400px] max-w-[400px]">
                                        <div>
                                            <div>
                                                <div className="mb-8">
                                                    <h3 className="mb-2">Verificação de código</h3>
                                                    <p className="font-semibold heading-text">Enviamos um código de verificação para o seu email.</p>
                                                </div>
                                                <div>
                                                ...
                                                <div className="mt-4 text-center">
                                                    <span className="font-semibold">Não recebeu o OTP? </span>
                                                    <button className="heading-text font-bold underline">Reenviar OTP</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                ...
                <div className="text-2xl header-action-item header-action-item-hoverable fixed ltr:right-0 rtl:left-0 top-96 p-3 rounded-none ltr:rounded-tl-lg ltr:rounded-bl-lg rtl:rounded-tr-lg rtl:rounded-br-lg text-white text-xl cursor-pointer select-none bg-primary hover:bg-primary! hover:text-white">
